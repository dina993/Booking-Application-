...
// Tag Color
const kTagHotelColor = Colors.black;
const kTagRentColor = Color(0xFF1F87FE);
const kTagFlightColor = Colors.green;
const kTagEventColor = Colors.pink;
// Rating Color
...
const SIZED_BOX_H20 = SizedBox(height: 30);
...
const SGN_HINT_EMAIL_TEXT = 'dinaNijim@mymail.com';
const SGN_HINT_PASS_TEXT = '********';
const SGN_PASS_TEXT = 'Password';

// Sign Up Screen String
const SGP_VERIFY_NUMBER_TEXT = 'Verify your number,please';
...
const HME_NEARBY_TEXT = 'Hotel Nearby';
const HME_INSPIRATION_TEXT = 'Top Rated';
