...
class DetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final _dtlSubTextStyle = Theme.of(context).textTheme.headline5.copyWith(
        color: kBackgroundLightColor,
        fontWeight: FontWeight.normal,
        fontSize: 12);
    final _dtlButtonTextStyle = Theme.of(context).textTheme.headline6.copyWith(
        color: kPrimaryColor, fontWeight: FontWeight.w600, fontSize: 13);
          ...
          child: Container(
            ...
            child: Center(
              child: Row(
                ...
                children: [
                  Text('\$${hotel.price.round()}',
                      style: _dtlPriceTextStyle.copyWith(fontSize: 18)),
                  Text(' / night', style: _dtlSubTextStyle),
                  Spacer(),
                  RawMaterialButton(
                      elevation: 0,
                      fillColor: kBackgroundLightColor,
                      constraints: BoxConstraints(minHeight: 35, minWidth: 130),
                      onPressed: () =>
