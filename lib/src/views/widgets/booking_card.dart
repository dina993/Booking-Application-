...
class BookingCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final bodTitleTextStyle = Theme.of(context).textTheme.headline5.copyWith(
        color: kPrimaryDarkenColor, fontWeight: FontWeight.w500, fontSize: 16);
    final _bodBody2TextStyle = Theme.of(context).textTheme.bodyText2;
    final _bodBody1TextStyle =
          ...
          children: [
            ...
            Padding(
              ...
              child: Align(
                ...
                child: Text(hotel.name, style: bodTitleTextStyle),
              ),
            ),
            Spacer(),
            Padding(
